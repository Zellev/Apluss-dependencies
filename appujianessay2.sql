...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2021 at 05:06 PM
...
(1912600027, 50050000, 'jumat', '09:00 - 11:00', 'telat input');
...
(1, 16, '1912627000', 'Kingsley Lyons', NULL, '081234567000', '2021-11-24 16:33:40', NULL),
...
(50050006, 3, 4, 'Teori Belajar dan Pembela', 4, 4, NULL),
...
(50050011, 1, 3, 'Perancangan Jaringan Komp', 1, 3, NULL),
...
INSERT INTO `paket_soal` (`kode_paket`, `kode_jenis_ujian`, `judul_ujian`, `tanggal_mulai`, `waktu_mulai`, `durasi_ujian`, `durasi_per_soal`, `bobot_per_soal`, `bobot_total`, `status`, `aktif`, `deskripsi`, `created_at`, `updated_at`) VALUES
('0EG64', 2, 'Penilaian Tengah Semester Pancasila', '2022-10-09', '14:12:00', '01:00:00', '00:03:00', 'sembunyikan', 100, 'draft', 0, 'test1234', '2021-12-24 22:55:40', NULL),
('51MVZ', 1, 'Penilaian Harian Pancasila', '2022-12-12', '14:12:00', '00:55:00', '00:05:00', 'tampilkan', 100, 'draft', 0, 'test123', '2021-12-20 14:04:39', NULL);
...
--
-- Dumping data for table `rel_kelas_paketsoal`
--

INSERT INTO `rel_kelas_paketsoal` (`id`, `kode_seksi`, `kode_paket`, `jenis_ujian`) VALUES
(1, 1912600003, '51MVZ', 1),
(2, 1912600003, '0EG64', 2);
...
INSERT INTO `rel_paketsoal_soal` (`id`, `kode_paket`, `kode_soal`, `no_urut_soal`) VALUES
(1, '51MVZ', 6, 1),
(2, '51MVZ', 1, 1),
(3, '51MVZ', 2, 2),
(4, '51MVZ', 3, 3),
...
CREATE TABLE `soal_essay` (
  ...
  `kode_dosen` int(11) UNSIGNED NOT NULL,
  `soal` text NOT NULL,
  `gambar_soal` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`gambar_soal`)),
  `bobot_soal` int(3) DEFAULT NULL,
...
INSERT INTO `soal_essay` (`kode_soal`, `kode_matkul`, `kode_dosen`, `soal`, `gambar_soal`, `bobot_soal`, `status`, `created_at`, `updated_at`) VALUES
(1, 50050002, 7, 'apa yang dimaksud dengan lorem ipsum?!', '[]', 10, 'terbit', '2021-12-20 18:02:01', NULL),
(2, 50050002, 7, 'oioioioioi test', '[]', 10, 'terbit', '2021-12-20 18:03:17', NULL),
(3, 50050002, 7, 'oioioioioi test', '[]', 10, 'terbit', '2021-12-20 21:07:57', NULL),
(4, 50050002, 7, 'lorem ipsum test', '[\"8_20-12-2021_22.58-appujian-test.png\"]', 10, 'terbit', '2021-12-20 22:58:45', NULL),
(5, 50050002, 7, 'lorem ipsum test 2', '[\"8_20-12-2021_23.7-appujian-test.png\",\"8_20-12-2021_23.7-appujian-apluss.png\"]', 10, 'terbit', '2021-12-20 23:07:39', NULL),
(6, 50050002, 7, 'testing 123 123 123', '[]', 25, 'terbit', '2021-12-21 22:01:04', NULL),
(7, 50050002, 7, 'yee yee yee yee!', '[]', 15, 'terbit', '2021-12-29 22:44:39', NULL),
(8, 50050002, 7, 'oioioioioioi test!', '[]', 15, 'terbit', '2021-12-29 22:44:59', NULL);
...
INSERT INTO `token_sessions` (`id_user`, `refresh_token`) VALUES
(8, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OCwidXNlcm5hbWUiOiJVc2VyIDgiLCJlbWFpbCI6ImNpdGFkZWxAYW9sLmNvbSIsImlhdCI6MTY0MDc5MjYzM30.DVzNT8Ss3bamc6oMZZxoI0CcBi2wlabwBItDQ5Anm84'),
(16, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTYsInVzZXJuYW1lIjoiVXNlciAxNiIsImVtYWlsIjoiYmFkZXJAbWFjLmNvbSIsImlhdCI6MTY0MDc2NTI3OH0.ut316jG9JafERCYzU54H25WmHfS5qIrsdlLLiO0r8sU');
...
(3, 'User 3', 'twoflower@mac.com', '$2b$10$/TFmW.vPyuvvEX7BqpjSB.gkYyYegtK/eyyZaWDCJwqsMs/gmZvkW', 'aktif', 2, NULL, NULL, '2021-11-24 16:32:59', NULL),
...
(10, 'User 10', 'muzzy@verizon.net', '$2b$10$JY1ZPo4VOosmmBbPd2Vfp.Ff1e0WHAegjB7YwThXE.WmoNM615HwS', 'aktif', 2, NULL, NULL, '2021-11-24 16:33:01', NULL),
...
(16, 'User 16', 'bader@mac.com', '$2b$10$k.5AWblEdKZ1LX.xCZs.nOQKQ0Pp28s6U5wI0ToJgHE2wnzNCBGB6', 'aktif', 3, NULL, NULL, '2021-11-24 16:33:40', NULL),
...
--
ALTER TABLE `soal_essay`
  MODIFY `kode_soal` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
ALTER TABLE `rel_paketsoal_soal`
  ...
  ADD CONSTRAINT `rel_paketsoal_soal_ibfk_2` FOREIGN KEY (`kode_soal`) REFERENCES `soal_essay` (`kode_soal`) ON DELETE CASCADE ON UPDATE CASCADE;
